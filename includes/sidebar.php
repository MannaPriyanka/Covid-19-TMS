...
<?php else:    ?>          
 ...
 <li class="nav-item">
			...
			<li class="nav-item">
                <a class="nav-link" href="hospital_search_report.php">
                    <i class="fas fa-fw fa-file"></i>
                    <span>Hospital Report</span></a>
            </li>
