                            ...
                            <form method="GET" action="" id="filter">
                                ...
                                <div class="row">
                                    <div class="col-md-5" style="display: none">
                                        ...
                                        <select onchange="print_city('city', this.selectedIndex, '');" id="sts" name="state" class="form-control shadow-none">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <select id="city" name="city" class="form-control shadow-none">
