    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item active">
              <a class="nav-link js-scroll-trigger" href="hospital/loginsystem/index.php">Hospital</a>
            </li>
          </ul>
    ...
    <div class="container" id="dash">
      <div class="">
        <div class="alert alert-info text-center">
          ...
          <h3><?php echo $output['recovered'];?></h3>
      ...
      <div class="row">
        <div class="col-6 col-md-3 mb-3">
          <div class="card" id="card1">
            <div class="card-body">
              <a href="resources.php?id=1&amp;type=OXYGEN">
                <div class="icon">
    ...
    border-style: none;" src="icons/oxygen.png" alt="id=1&amp;">
        ...
        <div class="col-6 col-md-3 mb-3">
          <div class="card" id="card2">
            <div class="card-body">
              <a href="resources.php?id=2&amp;type=MEDICINES">
                <div class="icon">
                  <img style="max-height: 100%;
    max-width: 100%;vertical-align: middle;
    border-style: none;" src="icons/remdesivir.png" alt="REMDESIVIR">
        ...
        <div class="col-6 col-md-3 mb-3">
          <div class="card" id="card3">
            <div class="card-body">
              <a href="resources.php?id=3&amp;type=HOSPITAL/AMBULANCE">
                <div class="icon">
                  <img style="max-height: 100%;
    max-width: 100%;vertical-align: middle;
    border-style: none;" src="icons/ambulance.png" alt="AMBULANCE">
        ...
        <div class="col-6 col-md-3 mb-3">
          <div class="card" id="card4">
            <div class="card-body">
              <a href="resources.php?id=4&amp;type=PLASMA">
                <div class="icon">
                  <img style="max-height: 100%;
    max-width: 100%;vertical-align: middle;
    border-style: none;" src="icons/plasma.png" alt="PLASMA">
        ...
        <div class="col-6 col-md-3 mb-3">
          <div class="card" id="card5">
            <div class="card-body">
              <a href="resources.php?id=5&amp;type=BLOOD DONERS">
                <div class="icon">
                  <img style="max-height: 100%;
    max-width: 100%;vertical-align: middle;
    border-style: none;" src="icons/blood-doners.png" alt="BLOOD DONERS">
        ...
        <div class="col-6 col-md-3 mb-3">
          <div class="card" id="card6">
            <div class="card-body">
              <a href="resources.php?id=6&amp;type=FOOD SERVICES">
                <div class="icon">
                  <img style="max-height: 100%;
    max-width: 100%;vertical-align: middle;
    border-style: none;" src="icons/food.png" alt="FOOD SERVICES">
        ...
        <div class="col-6 col-md-3 mb-3">
          <div class="card" id="card7">
            <div class="card-body">
              <a href="resources.php?id=7&amp;type=QUARANTINE PLACES">
                <div class="icon">
                  <img style="max-height: 100%;
    max-width: 100%;vertical-align: middle;
    border-style: none;" src="icons/quarantine-hospital.png" alt="QUARANTINE PLACES">
        ...
        <div class="col-6 col-md-3 mb-3">
          <div class="card" id="card8">
            <div class="card-body">
              <a href="resources.php?id=8&amp;type=AFTER-DEATH SERVICES">
                <div class="icon">
                  <img style="max-height: 100%;
    max-width: 100%;vertical-align: middle;
    border-style: none;" src="icons/tombstone.png" alt="AFTER-DEATH SERVICES">
        ...
        <div class="col-6 col-md-3 mb-3">
          <div class="card" id="card9">
            <div class="card-body">
              <a href="resources.php?id=9&amp;type=OTHER SERVICES">
                <div class="icon">
                  <img style="max-height: 100%;
    max-width: 100%;vertical-align: middle;
            ...
            <div class="card-body">
              <a href="add-resource.php">
                <div class="icon">
                  <img style="max-height: 100%;
    max-width: 100%;vertical-align: middle;
    border-style: none;" src="icons/add.jpg" alt="id=1&amp;">
                </div>
                <p class="text-center"> ADD RESOURCES
                </p>
              </a>
            </div>
          </div>
