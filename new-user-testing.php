...
curl_setopt_array($curl, array(
  CURLOPT_URL => "https://www.fast2sms.com/dev/bulkV2?authorization=m5GJ9xbk1ROhdaYtgy4NIBCl6pqoDvi7ZWuQSKrcUP0XEfLjM2KEBnUMXcQyiv8qSmNO1zbg0fHkPeI7&sender_id=TXTIND&message=".urlencode('DEAR USER ,This Message is from COVID-19 180 DEGREE  Your Order Number for '.$testtype. 'Test is'.$orderno.'')."&route=v3&numbers=".urlencode($mnumber),
